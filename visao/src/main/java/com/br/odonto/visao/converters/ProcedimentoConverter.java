 ...
 * @author murilo
 */
@FacesConverter("jsfProcedimentoConverter")
public class ProcedimentoConverter implements Converter{
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                ProcedimentoController con  = new ProcedimentoController();
                Procedimento c = con.buscar(id);
                return c;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        if(((Procedimento) o).getId() != null){
            return ((Procedimento) o).getId().toString();
        }else{
            return "";
        }
    }
